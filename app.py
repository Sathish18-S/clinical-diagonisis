...
# Ensure the 'static' folder exists for temporary file uploads
STATIC_DIR = "static"
...
def predict_diabetes():
    try:
        ...
        return render_template("diabets.html", diabetes_result=f"Diabetes Prediction: {result}")
    except Exception as e:
        return render_template("diabets.html", diabetes_result=f"Error: {str(e)}")
